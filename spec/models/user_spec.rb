    ...
    describe "#create" do
        ...
        context "when called with no params" do
            ...
            it "returns five errors" do
                expect(user.errors.count).to eql 5
            end
            ...
            it "returns blank risk tolerance error" do
                expect(user.errors[:risk_tolerance].first).to eql "can't be blank"
            end

            it "returns risk tolerance not num error" do
                expect(user.errors[:risk_tolerance].last).to eql "is not a number"
            end
