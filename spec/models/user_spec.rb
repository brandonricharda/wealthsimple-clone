...
RSpec.describe User, :type => :model do
    ...
    describe "#create" do
        ...
        context "when called without inputs" do
            ...
            it "doesn't return risk tolerance error" do
                expect(user.errors[:risk_tolerance].count).to eql 0
            end
        ...
        context "when called with email and password" do
            ...
            it "sets default risk tolerance to nil" do
                expect(user.risk_tolerance).to eql nil
            end
        ...
        context "when called with risk tolerance above 5" do
        ...
        context "when called with risk tolerance below 1" do
